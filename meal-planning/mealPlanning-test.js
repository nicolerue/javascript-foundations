...
describe("Meal Planning", function () {
  ...
  it("should add a dish to a meal", function () {
    ...
    assert.deepEqual(mealWithSpaghetti.dishes, [
  ...
  it("should add another dish to a meal", function () {
    ...
    var mealWithSpaghetti = addDish(meal, { name: "spaghetti", calories: 300 });
    var mealWithBread = addDish(mealWithSpaghetti, {
      name: "garlic bread",
      calories: 200,
    });

    assert.deepEqual(mealWithBread.dishes, [
      { name: "spaghetti", calories: 300 },
  ...
  it("should only add a dish if it meets or is below the meal's calorie goal", function () {
    ...
    assert.deepEqual(mealWithBread.dishes[0], {
      name: "garlic bread",
      calories: 200,
    });
  ...
  it("should update the calorieGoal when dishes are added", function () {
    ...
    var mealWithPancake = addDish(mealWithEggs, {
      name: "pancake",
      calories: 180,
    });
  ...
  it("should calculate the total meal calories", function () {
    ...
    var brunchWithOmelette = addDish(brunch, {
      name: "omelette",
      calories: 450,
    });
    var brunchWithFruit = addDish(brunchWithOmelette, {
      name: "fruit",
      calories: 100,
    });
  ...
  it("should calculate a different meal's calories", function () {
    ...
    var dinnerWithBeans = addDish(dinnerWithSoup, {
      name: "green beans",
      calories: 200,
    });
    var dinnerWithBrownie = addDish(dinnerWithBeans, {
      name: "brownie",
      calories: 400,
    });
